...
export class TabPanelsTab extends PluginSettingTab {
	...
	display(): void {
        ...
        // generalSettingGroup.setHeading("General")
        ...
        const stylingGroup = new SettingGroup(containerEl);
        stylingGroup.setHeading("Styling")
        
        stylingGroup.addSetting((setting: Setting) => {
            setting
        ...
        const experimentalGroup = new SettingGroup(containerEl);
        experimentalGroup.setHeading("Experimental")
        
        experimentalGroup.addSetting((setting: Setting) => {
        ...
        const additionalInfoGroup = new SettingGroup(containerEl);
        additionalInfoGroup.addSetting((setting: Setting) => {
            ...
            setting.setDesc(additionalInfo);
        });
	}
}
